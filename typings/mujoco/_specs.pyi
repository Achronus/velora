...
class MjSpec:
    ...
    def camera(self, arg0: str) -> MjsCamera:
        ...
    def compile(self, vfs: mujoco._specs.MjVfs | None = None) -> mujoco._structs.MjModel:
        ...
