...
from velora.disco.outputs import ContinuousDiscoPredictions, DiscoPredictions
...
class ContinuousDiscoNetwork(BaseCfC):
    """
    ...
    def __call__(
        ...
        *,
        h_state: Optional[chex.Array] = None,
        timespans: Optional[chex.Array] = None,
    ) -> Tuple[ContinuousDiscoPredictions, chex.Array]:
        """
        Forward pass through the network.
        ...
        Returns
        -------
        target_preds : ContinuousDiscoPredictions
        ...
        return ContinuousDiscoPredictions(
            embedding=embedding,
            mu=mu,
            log_std=log_std,
            y=y,
