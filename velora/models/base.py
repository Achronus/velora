...
class RLAgent:
    ...
    def __init__(
        ...
        self.actor: LiquidNCPModule | None = None
        self.critic: LiquidNCPModule | None = None
        self.critic2: LiquidNCPModule | None = None

        self.actor_target: LiquidNCPModule | None = None
        self.critic_target: LiquidNCPModule | None = None
        self.critic2_target: LiquidNCPModule | None = None
